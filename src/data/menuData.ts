...
const olimpica = '/menu-images/olimpica.png';
const mojitoFrutosRojos = '/menu-images/mojito-fr.png';
const dedosQueso = '/menu-images/dedos-queso.png';
const baconWestern = '/menu-images/bacon_doble.png';
const diablo = '/menu-images/diablo.png';
const jalapeños = '/menu-images/jalapenios.png';
const nuggets = '/menu-images/nuggets.png';
const aros = '/menu-images/aros_de_cebolla.png';
const nachosChilibean = '/menu-images/nachos.png';
const costillasElote = '/menu-images/costillas-elote.png';
const eloteAsado = '/menu-images/elote-asado.png';
const papasFrancesa = '/menu-images/papas-francesa.png';
const papasCurly = '/menu-images/papas-curly.png';
const papasGajo = '/menu-images/papas-gajo.png';
const cariPapas = '/menu-images/caripapas.png';
const papasWaffle = '/menu-images/papas-waffle.png';
const sensata = '/menu-images/sensata.png';
const dobleMoral = '/menu-images/doble-queso-pinia.png';
const hawaiana = '/menu-images/hawaiana.png';
const crujipollo = '/menu-images/crujipollo.png';
const pepperoniBurger = '/menu-images/peperoni.png';
const costraBurger = '/menu-images/costra-burger.png';
const ariWings = '/menu-images/alitas.png';
const boneless = '/menu-images/boneless.png';
const hotdog = '/menu-images/hot-dog.png';
const hotdogTocino = '/menu-images/hot-dog-tocino.png';
const hotdogHawaiano = '/menu-images/hot-dog-hawaiano.png';
const hotdogItalian = '/menu-images/hot-dog-italiano.png';
const costillas = '/menu-images/costilla.png';
const banderillas = '/menu-images/banderillas.png';
const paqueteBububurger = '/menu-images/paq-burger.png';
const paqueteNuggets = '/menu-images/paq-nuggets.png';
const paqueteHotdog = '/menu-images/paq-hot-dog.png';
const paqueteDeditos = '/menu-images/paq-deditos.png';
const refrescos = '/menu-images/refrescos-todos.png';
const boing = '/menu-images/boing-todos.png';
const aguaCiel = '/menu-images/ciel.png';
const bebidasPreparadas = '/menu-images/bebidas-prepa.png';
const energizantes = '/menu-images/energizantes.png';
const sodasItalianas = '/menu-images/sida-italiana.png';
const bebidaPanditas = '/menu-images/bebida-panditas2.png';
const cafes = '/menu-images/cafes.png';
const tisanas = '/menu-images/tisanas.png';
const digestivos = '/menu-images/digestivos.png';
const cocteles = '/menu-images/cocteles.png';
const aperitivos = '/menu-images/aperitivos.png';
const malteadas = '/menu-images/malteadas.png';
const mojitos = '/menu-images/mojitoss.png';
const colores = '/menu-images/colores.png';
const micheladasSabores = '/menu-images/micheladas-sabo.png';
const tritones = '/menu-images/tritones.png';
const tempura = '/menu-images/tempura.png';
const cervezaBarril = '/menu-images/cerveza-barril.png';
const strongbow = '/menu-images/strongbow-preparado.png';
const bubuchelas = '/menu-images/bubuchelas.png';
const tarros = '/menu-images/tarros.png';
const premium = '/menu-images/premium.png';
const nacionales = '/menu-images/nacionales.png';
const micheladasTrad = '/menu-images/micheladas-trad.png';
const destilados = '/menu-images/destilados.png';
